...
if(isset($_POST['register'])){
  ...
  $email_check ="SELECT * from `work` where email ='$user_email'";
  ...
  $insert_data = "INSERT INTO `work` (`name`, `email`, `password`) 
  VALUES ('$user_name ', '$user_email', '$pass')";
  $connects = mysqli_query($connect, $insert_data);
